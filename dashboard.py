...
from bokeh.models import GeoJSONDataSource, LinearColorMapper, NumeralTickFormatter, ColorBar, Text, Label, CheckboxGroup, Slider, TapTool, HoverTool, ColumnDataSource
...
query_num_co = "select state, SUM (CASE WHEN (barrels2008>0) THEN 1 ELSE 0 END), SUM (CASE WHEN (barrels2009>0) THEN 1 ELSE 0 END), SUM (CASE WHEN (barrels2010>0) THEN 1 ELSE 0 END), SUM (CASE WHEN (barrels2011>0) THEN 1 ELS$
                    from craft \
                    group by state"
query_population = "select state, percent, adults \
                    from population \
                    order by state desc"
states = {
        'AK': 'Alaska',
...
def modify_doc(doc):
    ...
    df_pop = pd.DataFrame(get_data(query_population), columns =['state', 'percent', 'adults'])
    ...
    splot.visible = False
    tplot.visible = False
    sales_plot.visible = False
    numco_plot.visible = False
    ...
    text_beer = Label(x=145, y=220, x_units='screen', y_units='screen',text='1,032,369',text_color='#013240',  text_font_size='28pt', text_font_style = 'bold', text_font = 'Roboto', text_baseline = 'middle', text_align='righ$
    ...
    text_numco = Label(x=145, y=180, x_units='screen', y_units='screen',text='750',text_color='#013240',  text_font_size='28pt', text_font_style = 'bold', text_font = 'Roboto', text_baseline = 'middle', text_align='right', x$
    ...
    text_rank = Label(x=145, y=140, x_units='screen', y_units='screen',text='1',text_color='#013240',  text_font_size='28pt', text_font_style = 'bold', text_font = 'Roboto', text_baseline = 'middle', text_align='right', x_of$
    ...
    text_rate = Label(x=145, y=100, x_units='screen', y_units='screen',text='5%',text_color='#013240',  text_font_size='28pt', text_font_style = 'bold', text_font = 'Roboto', text_baseline = 'middle', text_align='right', x_o$
    ...
    text_adults = Label(x=145, y=60, x_units='screen', y_units='screen',text='75%',text_color='#013240',  text_font_size='28pt', text_font_style = 'bold', text_font = 'Roboto', text_baseline = 'middle', text_align='right', x$
    ...
    text_capita = Label(x=145, y=20, x_units='screen', y_units='screen',text='2.8%',text_color='#013240',  text_font_size='28pt', text_font_style = 'bold', text_font = 'Roboto', text_baseline = 'middle', text_align='right', $
...
def bkapp_page():
    ...
    script = server_document(url='http://157.245.12.139:%d/bkapp' % port,
      arguments=dict(
